...
def Trustedlist(address,private_key, trusted, untrusted, client):
    trusted = trusted.split()
    untrusted = untrusted.split()
...
def vote(escrow_private_key, escrow_address, option_zero_address, option_one_address,option_two_address, client, vote):#"Vote 0 for zero and vote 1 for one: "
